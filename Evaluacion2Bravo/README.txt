...
a persistence unit "Evaluacion2PersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ec/ups/edu/Evaluacion2/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "Evaluacion2/pom.xml":
...
artifact ("Evaluacion2.war") is already built. You can build
